  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Success! 🎉",
        text2: "Your art ad has been posted",
        position: "top",
        visibilityTime: 2000,
      })
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      >
        ...
        <InputField label="Title" value={title} onChangeText={setTitle} placeholder="e.g., Abstract Painting" />
        <InputField label="Description" value={description} onChangeText={setDescription} placeholder="Describe your artwork..." multiline />
        <InputField label="Price (LKR)" value={price} onChangeText={setPrice} placeholder="e.g., 15000" keyboardType="numeric" />
