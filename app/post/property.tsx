  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Success! 🎉",
        text2: "Your property ad has been posted",
        position: "top",
        visibilityTime: 2000,
      })
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      >
        ...
        <InputField label="Title" value={title} onChangeText={setTitle} placeholder="e.g., Modern Apartment in Colombo" />
        <InputField label="Description" value={description} onChangeText={setDescription} placeholder="Describe your property..." multiline />
        <InputField label="Price (LKR)" value={price} onChangeText={setPrice} placeholder="e.g., 25000000" keyboardType="numeric" />
        <InputField label="Location" value={location} onChangeText={setLocation} placeholder="e.g., Colombo 03" />
        <InputField label="Bedrooms" value={bedrooms} onChangeText={setBedrooms} placeholder="e.g., 3" keyboardType="numeric" />
        <InputField label="Bathrooms" value={bathrooms} onChangeText={setBathrooms} placeholder="e.g., 2" keyboardType="numeric" />
        <InputField label="Square Feet" value={sqft} onChangeText={setSqft} placeholder="e.g., 1500" keyboardType="numeric" />

        <Text className="text-white font-semibold text-base mb-2">Condition</Text>
        <View className="flex-row gap-3 mb-6">
          {["New", "Used", "Renovated"].map((cond) => (
            <Pressable
              key={cond}
