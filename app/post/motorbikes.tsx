...
const MotorbikesPost = () => {
  ...
  const handleSubmit = async () => {
    if (!title || !description || !price || !brand || !model || !year || images.length === 0) {
      Toast.show({
        type: "error",
    ...
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Success! 🎉",
        text2: "Your motorbike ad has been posted",
        position: "top",
        visibilityTime: 2000,
      })
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      >
        ...
        <InputField label="Title" value={title} onChangeText={setTitle} placeholder="e.g., Honda CBR 2021" />
        <InputField label="Description" value={description} onChangeText={setDescription} placeholder="Describe your motorbike..." multiline />
        <InputField label="Price (LKR)" value={price} onChangeText={setPrice} placeholder="e.g., 850000" keyboardType="numeric" />
        <InputField label="Brand" value={brand} onChangeText={setBrand} placeholder="e.g., Honda" />
        <InputField label="Model" value={model} onChangeText={setModel} placeholder="e.g., CBR" />
        <InputField label="Year" value={year} onChangeText={setYear} placeholder="e.g., 2021" keyboardType="numeric" />
        <InputField label="Mileage (km)" value={mileage} onChangeText={setMileage} placeholder="e.g., 15000" keyboardType="numeric" />
